...
def train_one_epoch(
    ...
    for data_iter_step, batch in enumerate(data_loader):
        ...
        # =================================================================
        # 【核心修改 1】统一归一化：将输入和条件都从 [0, 1] 转为 [-1, 1]
        #  这是为了让模型学习从 "[-1,1]的条件" 映射到 "[-1,1]的图"
        # =================================================================
        if args.dataset in ['lol', 'euvp']:
             samples = samples * 2.0 - 1.0
             condition_signal = condition_signal * 2.0 - 1.0
        # =================================================================
        ...
        if args.discrete_flow_matching:
            ...
            samples =  ((samples + 1.0) / 2.0 * 255.0).to(torch.long)
