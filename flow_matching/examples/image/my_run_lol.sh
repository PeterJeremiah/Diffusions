...
#    --output_dir "/mnt/shared-storage-user/yangmingyuan/output_dir/experiment_010" \
    #--resume "/mnt/shared-storage-user/yangmingyuan/output_dir/experiment_007/checkpoint.pth"
...
torchrun --nproc_per_node=4 --nnodes=1 --node_rank=0 \
    ...
    --output_dir "/data/yangmingyuan/output_dir/experiment_lol_002" \
    #--resume "/data/yangmingyuan/output_dir/experiment_lol_001/checkpoint-49.pth"
